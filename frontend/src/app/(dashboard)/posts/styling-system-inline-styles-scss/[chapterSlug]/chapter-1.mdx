...
Although I've used CSS a lot, I'm not an expert. Therefore, though I will discuss some of my experiences with inline styles,
SCSS and CSS-in-JS, I can't make a strong case for which approaches should be preferred.
