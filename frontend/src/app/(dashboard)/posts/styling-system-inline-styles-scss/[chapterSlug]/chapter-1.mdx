...
This article describes an experimental approach. I think it contains interesting ideas, and can be of practical
value. I've used this approach in my Vidlito application, and got good results.
Although I've used CSS a lot, I'm not an expert. I focus on a subset of CSS that serves my purposes, but there is
always more to learn. Therefore, though I will discuss some of my experiences with inline styles, SCSS and CSS-in-JS,
I can't make a strong case for which approaches should be preferred.
