...
<CodeSnippet lang="html" addMb={true} code={code1} />
...
Before we continue I would like to point out that it can still be a good idea to create custom components based on TailwindUI snippets. You can do this
...
components is a very different approach from using third party components. Custom components are already shaped to meet the needs of the application.
...
<CodeSnippet lang="jsx" code={code2} />
