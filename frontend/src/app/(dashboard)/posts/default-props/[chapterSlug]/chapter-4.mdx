...
of the component tree see which default values.
...
We should keep in mind that sharing data is not the only option. We can use the same query in different components,
